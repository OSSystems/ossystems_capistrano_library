Capistrano::Configuration.instance(:must_exist).load do
  ...
  if deploy_via == :remote_cache
    ...
    set :check_tag, application_config["check_tag"].nil? ? true : application_config["check_tag"]
